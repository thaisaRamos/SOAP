...
public class TCountryInfo  implements java.io.Serializable {
    ...
    private org.oorsprong.www.websamples_countryinfo.TLanguage[] languages;
    ...
    public TCountryInfo(
           ...
           org.oorsprong.www.websamples_countryinfo.TLanguage[] languages) {
     ...
     * @return languages
     */
    public org.oorsprong.www.websamples_countryinfo.TLanguage[] getLanguages() {
        return languages;
    }
     ...
     * @param languages
     */
    public void setLanguages(org.oorsprong.www.websamples_countryinfo.TLanguage[] languages) {
        this.languages = languages;
    }
